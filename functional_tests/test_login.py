...
SUBJECT = 'Your login link for SimpleToDoList'
...
class LoginTest(FunctionalTest):
    ...
    def test_can_get_email_link_to_log_in(self):
        ...
        # Он говорит ей ввести свой адрес электройнной почты, что она и делает
        if self.staging_server:
            test_email = 'azanov.nik74@gmail.com'
        else:
    ...
    def wait_for_email(self, test_email, subjects):
        ...
        try:
            ...
            inbox.pass_(os.environ['POPGOOGLE_PASSWORD'])
